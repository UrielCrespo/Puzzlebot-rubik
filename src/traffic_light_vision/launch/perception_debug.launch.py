    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                # Bajado de 10.0 a 5.0 — aplica igual en modo debug.
                # En calibración estática 5 FPS de tráfico es más que suficiente.
